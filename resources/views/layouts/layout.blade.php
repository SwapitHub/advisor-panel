...
<head>
    ...
    <link rel="icon" href="{{ asset('/') }}public/storage/{{ $metedata['favicon'] }}" type="image/x-icon">
    <link rel="shortcut icon" href="{{ asset('/') }}public/storage/{{ $metedata['favicon'] }}" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css"
        href=" {{ asset('/') }}{{ asset('/') }}admin/css/vendors/chartist.css">
    <!-- Font Awesome-->
                ...
                <div class="main-header-left d-lg-none w-auto">
                    <div class="logo-wrapper">
                        <a href="{{ route('admin.dashboard') }}">
                            <h4 style="color:rgb(13, 13, 13); font-weight:700;text-transform:uppercase">Administrator</h4>
                            {{-- <img class="blur-up lazyloaded d-block d-lg-none"
                                src=" {{ asset('storage/') }}{{ $webInfo->logo }}" alt="Logo"
                                style="width:100%"> --}}
                        </a>
                    </div>
                </div>
                    ...
                    <ul class="nav-menus">
                        ...
                        <li class="onhover-dropdown">
                            ...
                            <div class="media align-items-center">
                                @if (!empty(Auth::user()->designation_icon))
                                    <img class="align-self-center pull-right img-50 blur-up lazyloaded"
                                        src=" {{ asset('storage') }}/{{ Auth::user()->designation_icon }}"
                                        alt="{{ Auth::user()->name }}">
                                @else
                                    <img class="align-self-center pull-right img-50 blur-up lazyloaded"
                            ...
                            <ul class="profile-dropdown onhover-show-div p-20">
                                ...
                                <li><a href="javascript:void(0)" onclick="logout('{{ route('admin.logout') }}')"><i data-feather="log-out"></i>Logout</a></li>
                            </ul>
                        </li>
                    </ul>
        ...
        <div class="page-body-wrapper">
            ...
            <div class="page-sidebar">
                <div class="main-header-left d-none d-lg-block">
                    <div class="logo-wrapper">
                        <a href="{{ route('admin.dashboard') }}">
                            <h3 style="color:white; font-weight:500;text-transform:uppercase">Administrator</h3>
                        {{-- <img
                                class="blur-up lazyloaded"
                                src=" {{ asset('storage') }}/{{ $webInfo->logo }}"
                                alt="{{ $webInfo->logo }}" style="width:100%"> --}}
                            </a>
                    </div>
                </div>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a class="sidebar-header" href="javascript:void(0)"><i
                                    data-feather="cpu"></i><span>Configuration</span><i
                                    class="fa fa-angle-right pull-right"></i></a>
                            <ul class="sidebar-submenu">
                                <li>
                                    <a href="{{ route('from.field.list') }}"><i class="fa fa-circle"></i>Form field options
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.distributor_relationship') }}"><i class="fa fa-circle"></i>From Content
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <a href="javascript:;" onclick="logout('{{ route('admin.logout') }}')" class="sidebar-header"><i data-feather="log-out"></i><span>Logout</span></a>
                        </li>
                    </ul>
                </div>
            </div>
