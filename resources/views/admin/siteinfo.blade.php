							...
							aria-labelledby="top-profile-tab">
								...
								method="POST" id="profile-form" enctype="multipart/form-data" data-parsley-validate>
									...
									<div class="form-group row">
										...
										<div class="col-xl-8 col-md-7">
											<input class="form-control dropify" id="logo" name="logo" data-default-file="{{ asset('storage') }}/{{ $siteinfo->logo }}" type="file">
										</div>
									</div>
									<div class="form-group row">
										<label for="validationCustom2" class="col-xl-3 col-md-4">Favicon</label>
										<div class="col-xl-8 col-md-7">
											<input class="form-control dropify" id="favicon" name="favicon" type="file" data-default-file="{{ asset('storage') }}/{{ $siteinfo->favicon }}">
										</div>
									</div>
									<div class="form-group row">
